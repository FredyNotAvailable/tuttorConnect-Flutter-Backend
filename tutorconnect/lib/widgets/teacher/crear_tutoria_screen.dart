...
class _CrearTutoriaScreenState extends ConsumerState<CrearTutoriaScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final inProgress = allEnrollments
        .where((e) => e.status == SubjectEnrollmentStatus.inProgress)
        .toList();
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.trim().isEmpty ? 'El tema es obligatorio' : null,
              ),
              ...
              DropdownButtonFormField<String>(
                ...
                items: teacherPlans.isEmpty
                    ...
                    : teacherPlans.map((plan) => plan.careerId).toSet().map((careerId) {
              ...
              DropdownButtonFormField<int>(
                ...
                onChanged: (value) => _onCycleChanged(value, teacherPlans),
              ...
              DropdownButtonFormField<String>(
                ...
                items: availableSubjectsObjects.map((subject) {
                  return DropdownMenuItem(
                    value: subject.id,
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    _studentIds = inProgress
                        .where((e) => e.subjectId == value)
                        .map((e) => e.studentId)
                        .toList();
                  });
                },
              ...
              if (_selectedSubjectId != null)
                Column(
                  ...
                  children: [
                    const Text('Estudiantes inscritos (En progreso):',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    ...allUsers
                        .where((u) =>
                            u.role == UserRole.student &&
                            _studentIds.contains(u.id))
                        .map((e) => ListTile(
              ...
              DropdownButtonFormField<String>(
                ...
                items: classrooms.map((aula) {
                  return DropdownMenuItem(
                    value: aula.id,
                    child: Text('${aula.name} - ${aula.type.name}'),
                  );
                }).toList(),
                onChanged: (value) => setState(() => _classroomId = value),
                value: _classroomId,
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                        _startTime == null ? 'Seleccionar hora' : _startTime!.format(context)),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                        _endTime == null ? 'Seleccionar hora' : _endTime!.format(context)),
                  ),
                ],
              ),
